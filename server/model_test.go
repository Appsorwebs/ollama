	...
	for _, tt := range cases {
		t.Run(tt.model, func(t *testing.T) {
			...
			t.Run("parse", func(t *testing.T) {
				...
				actual, _, ok := m.ParseToolCallsStreamNew(tt.output, &prefix, &specialToken)
				if ok != tt.ok {
...
func TestParseToolCallsNew(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.input, func(t *testing.T) {
			...
			var prefix string
			var specialToken string
			got, _, ok := m.ParseToolCallsStreamNew(tc.input, &prefix, &specialToken)
			if !ok {
...
func TestParseToolCallsStream(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			var prefix string
			var specialToken string
			got, partial, success := m.ParseToolCallsStreamNew(tc.input, &prefix, &specialToken)
